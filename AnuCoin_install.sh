...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='AnuCoin.conf'
CONFIGFOLDER='/root/.AnuCoin'
COIN_DAEMON='AnuCoind'
COIN_CLI='AnuCoind'
...
purgeOldInstallation() {
    ...
    #kill wallet daemon
    sudo killall AnuCoind > /dev/null 2>&1
    #remove old ufw port allow
    sudo ufw delete allow 36963/tcp > /dev/null 2>&1
    #remove old files
    if [ -d "~/.AnuCoin" ]; then
        sudo rm -rf ~/.AnuCoin > /dev/null 2>&1
    fi
    #remove binaries and AnuCoin utilities
    cd /usr/local/bin && sudo rm AnuCoin-cli AnuCoin-tx AnuCoind > /dev/null 2>&1 && cd
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${PURPLE}Windows Wallet Guide. https://github.com/Realbityoda/AnuCoin/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}AnuCoind masternode status${NC}"
 echo -e "${GREEN}AnuCoind getinfo.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${RED}Donations always excepted gratefully.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${YELLOW}ANU: AHCQMtqdovWbhAuAcqBfskM3T31ayU5unp${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
