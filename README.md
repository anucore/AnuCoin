...
If you require further assistance contact the support team @ [Discord](https://discord.gg/sY9pVBb)
***
## Requirements
1) **100,000 AnuCoin coins.**
...
`wget -q https://raw.githubusercontent.com/anucore/AnuCoinMnsetup/master/AnuCoin_install.sh`
***

***Step 8***
* Paste the code below into the Bitvise terminal then press enter

`bash AnuCoin_install.sh`
...
***Step 1***
* Download and install the AnuCoin wallet [here](https://github.com/anucore/anucore/releases)
***

***Step 2***
* Send EXACLY 100,000 ANU to a receive address within your wallet.
***
